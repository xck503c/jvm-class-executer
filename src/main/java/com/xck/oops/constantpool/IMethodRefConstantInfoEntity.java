 ...
 * }
 */
public class IMethodRefConstantInfoEntity extends ConstantPoolEntity {

    private int classIndex; //指向常量池的索引，指向的索引项是一个CONSTANT_Utf8_info类型
    private int nameAndTypeIdex;

    public IMethodRefConstantInfoEntity(InputStream is) throws IOException{
        byte[] b = new byte[2];
        is.read(b);
    ...
    public String toString() {
        return "IMethodRefConstantInfoEntity{" +
